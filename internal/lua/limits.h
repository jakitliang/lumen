...
namespace Lua {
    ...
    */
    ...
    typedef Lua::Value *StkId;  /* index to stack elements */
...
#define LuaDo(block) do { block } while(0)
...
*/
#define LuaIntPoint(p)  ((unsigned int)(Lua::MemorySize)(p))
...
#define LuaCheckExp(c, e)    (e)
#define LuaApiCheck          luai_apicheck
#endif
...
#define cast_byte(i)    cast(Lua::Byte, (i))
#define cast_num(i)     cast(lua_Number, (i))
#define cast_int(i)     cast(int, (i))


#ifndef lua_lock
#define LuaLock(L)    ((void) 0)
#else
#define LuaLock(L)    lua_lock
#endif

#ifndef lua_unlock
#define LuaUnlock(L)    ((void) 0)
#else
#define LuaUnlock(L)    lua_unlock
#endif

#ifndef luai_threadyield
#define LuaThreadYield(L)    LuaDo(LuaUnlock(L); LuaLock(L);)
#else
#define LuaThreadYield       luai_threadyield
#endif
...
#define LuaCondHardStackTests(x)    ((void)0)
#else
#define LuaCondHardStackTests(x)    x
#endif
